...
GET /api/v1/oc/power-sorting/default-sort-order/{parentId}

# Save current as default
POST /api/v1/oc/power-sorting/default-sort-order/save
{
  "parentId": "guid"
}

# Restore default
POST /api/v1/oc/power-sorting/default-sort-order/restore/{parentId}

# Clear default
DELETE /api/v1/oc/power-sorting/default-sort-order/{parentId}
```
