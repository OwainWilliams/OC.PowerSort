...
A new table `ocPowerSortSchedule` stores all schedule configurations:
...
### Get All Schedules
```
GET /umbraco/management/api/v1/oc/power-sort/schedules
GET /umbraco/management/api/v1/oc/power-sort/schedules?parentId={guid}
GET /umbraco/management/api/v1/oc/power-sort/schedules?activeOnly=true
```

### Get Single Schedule
```
GET /umbraco/management/api/v1/oc/power-sort/schedules/{id}
```

### Create Schedule
```
POST /umbraco/management/api/v1/oc/power-sort/schedules
{
  "contentId": "guid",
  "parentId": "guid",
  "targetPosition": 0,
...
### Update Schedule
```
PUT /umbraco/management/api/v1/oc/power-sort/schedules/{id}
{
  "targetPosition": 1,
  "startDateTime": "2024-01-15T09:00:00Z",
  "endDateTime": "2024-01-15T10:00:00Z",
...
### Delete Schedule
```
DELETE /umbraco/management/api/v1/oc/power-sort/schedules/{id}
```

### Get Active Schedules for Parent
```
GET /umbraco/management/api/v1/oc/power-sort/schedules/active/{parentId}
```
...
To temporarily disable scheduling, comment out the service registration in `OCPowerSortApiComposer.cs`:
